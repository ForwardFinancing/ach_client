module AchClient
  class SiliconValleyBank
    ...
    class AchTransaction < Abstract::AchTransaction
      ...
      # @param trace_id [String] identifier for us to track transaction
      def self.arguments
        super + [:trace_id]
      end
      ...
      def to_entry_detail
        ...
        entry.individual_id_number = trace_id # Doesn't need to be a number
        ...
        # Not sure what this does yet, suspect is foreign key set by us
        entry.trace_number = trace_id.to_i # Does need to be a number
        entry
      end
